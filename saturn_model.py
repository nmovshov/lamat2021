...
debug = False
user_params = {
    'z1':9*0.015, # outer envelope metallicity (solar is ~0.015)
    'rio':2e-1, # Inner jump's outer (normalized) radius
    'roo':6e-1, # Outer jump's outer (normalized) radius
    'y2_xy':4e-1, # Deep helium mass fraction y/(x+y)=y/(1-z)
    'drho_a':-0.13261, # Amplitude (drho/rho) of rho_hhe perturbation.
